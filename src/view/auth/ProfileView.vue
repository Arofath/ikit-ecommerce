            ...
            <form @submit.prevent="handleUpdateProfile" class="p-6">
              ...
              <div class="flex justify-end pt-4 border-t border-slate-100">
                <button
                  ...
                  class="px-8 py-2.5 bg-blue-600 text-white rounded-xl font-semibold shadow-lg shadow-blue-600/30 hover:bg-blue-700 hover:-translate-y-0.5 transition-all disabled:opacity-70 disabled:cursor-not-allowed flex items-center gap-2"
                >
